<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:list" mode="ids">
        ...
        <xsl:for-each
            select="distinct-values(descendant::tei:correspDesc[tei:correspAction[@type='sent'][1]/tei:persName/@ref='#pmb2121']/tei:correspAction[@type='sent' or @type='received']/tei:placeName[1][@ref[starts-with(., '#pmb')]]/tokenize(normalize-space(@ref), ' ')[1])">
